# ==========================================
# EAS ENGINE (NITRATION, HALOGENATION, FRIEDEL-CRAFTS)
# ==========================================
...
EAS_RULES = {
    ...
    "Conc. HNO3 / Conc. H2SO4 (Nitration)": {
        "rules": [
    ...
    # --- HALOGENATION ---
    "Cl2 / FeCl3 or AlCl3 (Chlorination)": {
        "rules": [
    ...
    "Br2 / H2O (Phenol/Aniline Exhaustive Bromination)": {
        "rules": [
            # Highly activated rings without a Lewis Acid catalyst undergo 2,4,6-tribromination
    ...
    "CH3Cl / Anhydrous AlCl3 (FC Alkylation)": {
        "rules": [
    ...
    "CH3COCl / Anhydrous AlCl3 (FC Acylation)": {
        "rules": [
